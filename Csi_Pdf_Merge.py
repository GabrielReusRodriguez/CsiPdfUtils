...
class MySOAPRequestHandler(SOAPRequestHandler):
    ...
    #invocation URL ("path").
        ...
        wsdlfile = os.path.join('.', "./wsdl/ED_INT040_PDfUtils_merge_WSDL.wsdl")
...
def AsServer(port=80, services=(), RequestHandlerClass=SOAPRequestHandler,direccion):
...
#Configuramos la dirección y el puerto del WebService, ademñas de la clase que implementa el servicio
AsServer(port=8080, services=[PdfMerge_Service()], RequestHandlerClass=MySOAPRequestHandler,direccion='172.28.105.55')
